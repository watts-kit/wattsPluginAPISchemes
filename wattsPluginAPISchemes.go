// Package schemes declares govalid schemes to check watts plugin API input and output.
package schemes
...
var (
	...
	// PluginInputScheme is used to validate the input of a plugin
	...
	// PluginOutputScheme is used to validate the output of a plugin
	PluginOutputScheme = map[string](map[string]v.Validator){
